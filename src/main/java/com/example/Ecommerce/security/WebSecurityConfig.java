...
import com.example.Ecommerce.security.services.UserDetailServiceImpl;
...
public class WebSecurityConfig {
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http.csrf(csrf -> csrf.disable())
                ...
                .authorizeHttpRequests(auth ->
                        ...
                        //To enable security change permitAll() to authenticated.
                );
    ...
    //used to completely bypass spring security
    @Bean

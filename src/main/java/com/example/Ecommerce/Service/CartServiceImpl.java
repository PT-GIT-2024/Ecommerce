...
public class CartServiceImpl implements CartService{
    ...
    public CartDTO addProductToCart(Long productId, Integer quantity) {
        ...
        //Creates new cart or returns existing cart for a specific User
        ...
        //Fetch cartItem ; each cart has only 1 cartItem of a particular productId
        ...
        //Saving CartItem to DB
        cartItemRepository.save(newCartItem);

        //Updating remaining product Quantity
        ...
        //Mapping cart to cartDto to return
    ...
    public List<CartDTO> getAllCarts() {
        ...
        List<CartDTO> cartDTOs = carts.stream().map(cart -> {
            ...
            //CartDto has List of productDto's
    ...
    public void updateProductInCarts(Long cartId, Long productId) {
        ...
        //subtract old item's price from total cart price
        double cartPrice = cart.getTotalPrice() - (cartItem.getProductPrice() * cartItem.getQuantity());

        cartItem.setProductPrice(product.getSpecialPrice());

        //Add new Item's price to total cart price
